...
class MetaAdsMCPClient:
    ...
    async def create_campaign(
        ...
        """Create a campaign in PAUSED state."""
        return await self._call_tool("create_campaign", {
    ...
    async def update_campaign(self, campaign_id: str, status: str) -> dict[str, Any]:
        ...
        return await self._call_tool("update_campaign", {
    ...
    async def list_campaigns(self) -> list[dict[str, Any]]:
        ...
        result = await self._call_tool("get_campaign_performance", {
            "account_id": self._ad_account_id,
        })
    ...
    async def create_adset(
        ...
        return await self._call_tool("create_ad_set", {
            "account_id": self._ad_account_id,
            "campaign_id": campaign_id,
            "name": name,
    ...
    async def update_ad(self, ad_id: str, status: str) -> dict[str, Any]:
        return await self._call_tool("update_ad", {"ad_id": ad_id, "status": status})
    ...
    async def get_insights(
        ...
        result = await self._call_tool("get_performance_analytics", {
            "account_id": self._ad_account_id,
            "campaign_id": campaign_id,
    ...
    async def get_reach_estimate(
        ...
        return await self._call_tool("get_reach_estimate", {
            "account_id": self._ad_account_id,
