...
class Settings(BaseSettings):
    ...
    # --------------------------------------------------------------------------
    # System user token for Graph API; MCP mode needs a user token instead
    ...
    # Route Meta writes/insights through the official Ads MCP server instead of Graph API
